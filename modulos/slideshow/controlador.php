<?php
	require_once("$_SERVER[DOCUMENT_ROOT]/genesis_bazar/granlibreria.php");
	require_once("$_SERVER[DOCUMENT_ROOT]/genesis_bazar/modulos/buscador/traer_lista.php");
	require_once("$_SERVER[DOCUMENT_ROOT]/genesis_bazar/modulos/buscador/traer_titulo.php");
	require_once("$_SERVER[DOCUMENT_ROOT]/genesis_bazar/modulos/buscador/traer_formulario.php");
